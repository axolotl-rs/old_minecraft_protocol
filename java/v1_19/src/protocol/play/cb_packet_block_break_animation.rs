use minecraft_data :: protocol :: PacketContent ; use minecraft_data :: protocol :: PacketSwitch ; use minecraft_data :: protocol :: Packet ; use std :: io :: { BufRead , Error , ErrorKind , Result , Write } ; use std :: str :: FromStr ;
 ...
 pub struct CbPacketBlockBreakAnimation ; impl Packet for CbPacketBlockBreakAnimation { type PacketIDType = i32 ; type PacketContent = PacketBlockBreakAnimationContent ; fn packet_id ( ) -> Self :: PacketIDType where Self : Sized { 9 } } pub struct PacketBlockBreakAnimationContent { entity_id: minecraft_data::data::VarInt ,
