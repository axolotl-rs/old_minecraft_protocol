use minecraft_data :: protocol :: PacketContent ; use minecraft_data :: protocol :: PacketSwitch ; use minecraft_data :: protocol :: Packet ; use std :: io :: { BufRead , Error , ErrorKind , Result , Write } ; use std :: str :: FromStr ;
 ...
 pub struct SbPacketPong ; impl Packet for SbPacketPong { type PacketIDType = i32 ; type PacketContent = PacketPongContent ; fn packet_id ( ) -> Self :: PacketIDType where Self : Sized { 29 } } pub struct PacketPongContent { pub id: i32 ,
