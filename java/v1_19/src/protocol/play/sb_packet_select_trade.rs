use minecraft_data :: protocol :: PacketContent ; use minecraft_data :: protocol :: PacketSwitch ; use minecraft_data :: protocol :: Packet ; use std :: io :: { BufRead , Error , ErrorKind , Result , Write } ; use std :: str :: FromStr ;
 ...
 pub struct SbPacketSelectTrade ; impl Packet for SbPacketSelectTrade { type PacketIDType = i32 ; type PacketContent = PacketSelectTradeContent ; fn packet_id ( ) -> Self :: PacketIDType where Self : Sized { 35 } } pub struct PacketSelectTradeContent { pub slot: minecraft_data::data::VarInt ,
