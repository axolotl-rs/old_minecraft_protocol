use minecraft_protocol :: protocol :: PacketContent ; use minecraft_protocol :: protocol :: PacketSwitch ; use minecraft_protocol :: protocol :: Packet ; use std :: io :: { BufRead , Error , ErrorKind , Result , Write } ; use std :: str :: FromStr ;
 ...
 pub struct CbPacketSetTitleTime ; impl Packet for CbPacketSetTitleTime { type PacketIDType = i32 ; type PacketContent = PacketSetTitleTimeContent ; fn packet_id ( ) -> Self :: PacketIDType where Self : Sized { 91 } } pub struct PacketSetTitleTimeContent { pub fade_in: i32 ,
