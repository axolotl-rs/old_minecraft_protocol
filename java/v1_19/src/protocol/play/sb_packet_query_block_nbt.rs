use minecraft_data :: protocol :: PacketContent ; use minecraft_data :: protocol :: PacketSwitch ; use minecraft_data :: protocol :: Packet ; use std :: io :: { BufRead , Error , ErrorKind , Result , Write } ; use std :: str :: FromStr ;
 ...
 pub struct SbPacketQueryBlockNbt ; impl Packet for SbPacketQueryBlockNbt { type PacketIDType = i32 ; type PacketContent = PacketQueryBlockNbtContent ; fn packet_id ( ) -> Self :: PacketIDType where Self : Sized { 1 } } pub struct PacketQueryBlockNbtContent { transaction_id: minecraft_data::data::VarInt ,
