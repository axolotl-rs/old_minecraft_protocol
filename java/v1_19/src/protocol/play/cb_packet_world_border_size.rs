use minecraft_protocol :: protocol :: PacketContent ; use minecraft_protocol :: protocol :: PacketSwitch ; use minecraft_protocol :: protocol :: Packet ; use std :: io :: { BufRead , Error , ErrorKind , Result , Write } ; use std :: str :: FromStr ;
 ...
 pub struct CbPacketWorldBorderSize ; impl Packet for CbPacketWorldBorderSize { type PacketIDType = i32 ; type PacketContent = PacketWorldBorderSizeContent ; fn packet_id ( ) -> Self :: PacketIDType where Self : Sized { 68 } } pub struct PacketWorldBorderSizeContent { pub diameter: f64 ,
