use minecraft_data :: protocol :: PacketContent ; use minecraft_data :: protocol :: PacketSwitch ; use minecraft_data :: protocol :: Packet ; use std :: io :: { BufRead , Error , ErrorKind , Result , Write } ; use std :: str :: FromStr ;
 ...
 pub struct CbPacketSpawnPosition ; impl Packet for CbPacketSpawnPosition { type PacketIDType = i32 ; type PacketContent = PacketSpawnPositionContent ; fn packet_id ( ) -> Self :: PacketIDType where Self : Sized { 75 } } pub struct PacketSpawnPositionContent { pub location: minecraft_data::data::position::Position ,
