use minecraft_data :: protocol :: PacketContent ; use minecraft_data :: protocol :: PacketSwitch ; use minecraft_data :: protocol :: Packet ; use std :: io :: { BufRead , Error , ErrorKind , Result , Write } ; use std :: str :: FromStr ;
 ...
 pub struct CbPacketCamera ; impl Packet for CbPacketCamera { type PacketIDType = i32 ; type PacketContent = PacketCameraContent ; fn packet_id ( ) -> Self :: PacketIDType where Self : Sized { 71 } } pub struct PacketCameraContent { camera_id: minecraft_data::data::VarInt ,
