use minecraft_data :: protocol :: PacketContent ; use minecraft_data :: protocol :: PacketSwitch ; use minecraft_data :: protocol :: Packet ; use std :: io :: { BufRead , Error , ErrorKind , Result , Write } ; use std :: str :: FromStr ;
 ...
 pub struct CbPacketSetPassengers ; impl Packet for CbPacketSetPassengers { type PacketIDType = i32 ; type PacketContent = PacketSetPassengersContent ; fn packet_id ( ) -> Self :: PacketIDType where Self : Sized { 84 } } pub struct PacketSetPassengersContent { entity_id: minecraft_data::data::VarInt ,
