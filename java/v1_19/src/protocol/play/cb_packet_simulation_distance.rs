use minecraft_data :: protocol :: PacketContent ; use minecraft_data :: protocol :: PacketSwitch ; use minecraft_data :: protocol :: Packet ; use std :: io :: { BufRead , Error , ErrorKind , Result , Write } ; use std :: str :: FromStr ;
 ...
 pub struct CbPacketSimulationDistance ; impl Packet for CbPacketSimulationDistance { type PacketIDType = i32 ; type PacketContent = PacketSimulationDistanceContent ; fn packet_id ( ) -> Self :: PacketIDType where Self : Sized { 87 } } pub struct PacketSimulationDistanceContent { distance: minecraft_data::data::VarInt ,
