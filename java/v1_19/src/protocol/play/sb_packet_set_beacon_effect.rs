use minecraft_data :: protocol :: PacketContent ; use minecraft_data :: protocol :: PacketSwitch ; use minecraft_data :: protocol :: Packet ; use std :: io :: { BufRead , Error , ErrorKind , Result , Write } ; use std :: str :: FromStr ;
 ...
 pub struct SbPacketSetBeaconEffect ; impl Packet for SbPacketSetBeaconEffect { type PacketIDType = i32 ; type PacketContent = PacketSetBeaconEffectContent ; fn packet_id ( ) -> Self :: PacketIDType where Self : Sized { 36 } } pub struct PacketSetBeaconEffectContent { primary_effect: minecraft_data::data::VarInt ,

secondary_effect: minecraft_data::data::VarInt ,
