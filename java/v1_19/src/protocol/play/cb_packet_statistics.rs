use minecraft_data :: protocol :: PacketContent ; use minecraft_data :: protocol :: PacketSwitch ; use minecraft_data :: protocol :: Packet ; use std :: io :: { BufRead , Error , ErrorKind , Result , Write } ; use std :: str :: FromStr ;
 ...
 Ok ( Self { entries } ) } } pub type PacketStatisticsContentArray = Vec <PacketStatisticsContentArrayContent >; pub struct PacketStatisticsContentArrayContent { pub category_id: minecraft_data::data::VarInt ,

pub statistic_id: minecraft_data::data::VarInt ,

pub value: minecraft_data::data::VarInt ,
