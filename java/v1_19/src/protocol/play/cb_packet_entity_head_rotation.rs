use minecraft_data :: protocol :: PacketContent ; use minecraft_data :: protocol :: PacketSwitch ; use minecraft_data :: protocol :: Packet ; use std :: io :: { BufRead , Error , ErrorKind , Result , Write } ; use std :: str :: FromStr ;
 ...
 pub struct CbPacketEntityHeadRotation ; impl Packet for CbPacketEntityHeadRotation { type PacketIDType = i32 ; type PacketContent = PacketEntityHeadRotationContent ; fn packet_id ( ) -> Self :: PacketIDType where Self : Sized { 62 } } pub struct PacketEntityHeadRotationContent { pub entity_id: minecraft_data::data::VarInt ,
