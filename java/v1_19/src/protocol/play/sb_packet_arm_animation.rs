use minecraft_data :: protocol :: PacketContent ; use minecraft_data :: protocol :: PacketSwitch ; use minecraft_data :: protocol :: Packet ; use std :: io :: { BufRead , Error , ErrorKind , Result , Write } ; use std :: str :: FromStr ;
 ...
 pub struct SbPacketArmAnimation ; impl Packet for SbPacketArmAnimation { type PacketIDType = i32 ; type PacketContent = PacketArmAnimationContent ; fn packet_id ( ) -> Self :: PacketIDType where Self : Sized { 44 } } pub struct PacketArmAnimationContent { hand: minecraft_data::data::VarInt ,
