use minecraft_data :: protocol :: PacketContent ; use minecraft_data :: protocol :: PacketSwitch ; use minecraft_data :: protocol :: Packet ; use std :: io :: { BufRead , Error , ErrorKind , Result , Write } ; use std :: str :: FromStr ;
 ...
 pub struct CbPacketOpenBook ; impl Packet for CbPacketOpenBook { type PacketIDType = i32 ; type PacketContent = PacketOpenBookContent ; fn packet_id ( ) -> Self :: PacketIDType where Self : Sized { 45 } } pub struct PacketOpenBookContent { pub hand: minecraft_data::data::VarInt ,
