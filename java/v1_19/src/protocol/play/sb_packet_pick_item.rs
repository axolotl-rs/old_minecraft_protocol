use minecraft_data :: protocol :: PacketContent ; use minecraft_data :: protocol :: PacketSwitch ; use minecraft_data :: protocol :: Packet ; use std :: io :: { BufRead , Error , ErrorKind , Result , Write } ; use std :: str :: FromStr ;
 ...
 pub struct SbPacketPickItem ; impl Packet for SbPacketPickItem { type PacketIDType = i32 ; type PacketContent = PacketPickItemContent ; fn packet_id ( ) -> Self :: PacketIDType where Self : Sized { 23 } } pub struct PacketPickItemContent { slot: minecraft_data::data::VarInt ,
