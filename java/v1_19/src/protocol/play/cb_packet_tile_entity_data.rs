use minecraft_data :: protocol :: PacketContent ; use minecraft_data :: protocol :: PacketSwitch ; use minecraft_data :: protocol :: Packet ; use std :: io :: { BufRead , Error , ErrorKind , Result , Write } ; use std :: str :: FromStr ;
 ...
 pub struct CbPacketTileEntityData ; impl Packet for CbPacketTileEntityData { type PacketIDType = i32 ; type PacketContent = PacketTileEntityDataContent ; fn packet_id ( ) -> Self :: PacketIDType where Self : Sized { 10 } } pub struct PacketTileEntityDataContent { pub location: minecraft_data::data::position::Position ,
