use minecraft_data :: protocol :: PacketContent ; use minecraft_data :: protocol :: PacketSwitch ; use minecraft_data :: protocol :: Packet ; use std :: io :: { BufRead , Error , ErrorKind , Result , Write } ; use std :: str :: FromStr ;
 ...
 pub struct SbPacketVehicleMove ; impl Packet for SbPacketVehicleMove { type PacketIDType = i32 ; type PacketContent = PacketVehicleMoveContent ; fn packet_id ( ) -> Self :: PacketIDType where Self : Sized { 21 } } pub struct PacketVehicleMoveContent { pub x: f64 ,
