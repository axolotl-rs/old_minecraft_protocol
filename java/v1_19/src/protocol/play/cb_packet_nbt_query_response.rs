use minecraft_data :: protocol :: PacketContent ; use minecraft_data :: protocol :: PacketSwitch ; use minecraft_data :: protocol :: Packet ; use std :: io :: { BufRead , Error , ErrorKind , Result , Write } ; use std :: str :: FromStr ;
 ...
 pub struct CbPacketNbtQueryResponse ; impl Packet for CbPacketNbtQueryResponse { type PacketIDType = i32 ; type PacketContent = PacketNbtQueryResponseContent ; fn packet_id ( ) -> Self :: PacketIDType where Self : Sized { 96 } } pub struct PacketNbtQueryResponseContent { transaction_id: minecraft_data::data::VarInt ,

nbt: minecraft_data::data::nbt::OptionalNbt ,
