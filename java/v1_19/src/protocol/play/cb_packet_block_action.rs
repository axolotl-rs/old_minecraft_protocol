use minecraft_protocol :: protocol :: PacketContent ; use minecraft_protocol :: protocol :: PacketSwitch ; use minecraft_protocol :: protocol :: Packet ; use std :: io :: { BufRead , Error , ErrorKind , Result , Write } ; use std :: str :: FromStr ;
 ...
 pub struct CbPacketBlockAction ; impl Packet for CbPacketBlockAction { type PacketIDType = i32 ; type PacketContent = PacketBlockActionContent ; fn packet_id ( ) -> Self :: PacketIDType where Self : Sized { 11 } } pub struct PacketBlockActionContent { pub location: minecraft_protocol::data::position::Position ,

pub byte_1: u8 ,

pub byte_2: u8 ,

pub block_id: minecraft_protocol::data::VarInt ,
...
let block_id : minecraft_protocol::data::VarInt = PacketContent :: read ( reader ) ?;;
