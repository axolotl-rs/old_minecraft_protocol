use minecraft_data :: protocol :: PacketContent ; use minecraft_data :: protocol :: PacketSwitch ; use minecraft_data :: protocol :: Packet ; use std :: io :: { BufRead , Error , ErrorKind , Result , Write } ; use std :: str :: FromStr ;
 ...
 pub struct CbPacketEndCombatEvent ; impl Packet for CbPacketEndCombatEvent { type PacketIDType = i32 ; type PacketContent = PacketEndCombatEventContent ; fn packet_id ( ) -> Self :: PacketIDType where Self : Sized { 51 } } pub struct PacketEndCombatEventContent { duration: minecraft_data::data::VarInt ,
