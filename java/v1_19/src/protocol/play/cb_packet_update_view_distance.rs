use minecraft_data :: protocol :: PacketContent ; use minecraft_data :: protocol :: PacketSwitch ; use minecraft_data :: protocol :: Packet ; use std :: io :: { BufRead , Error , ErrorKind , Result , Write } ; use std :: str :: FromStr ;
 ...
 pub struct CbPacketUpdateViewDistance ; impl Packet for CbPacketUpdateViewDistance { type PacketIDType = i32 ; type PacketContent = PacketUpdateViewDistanceContent ; fn packet_id ( ) -> Self :: PacketIDType where Self : Sized { 74 } } pub struct PacketUpdateViewDistanceContent { pub view_distance: minecraft_data::data::VarInt ,
