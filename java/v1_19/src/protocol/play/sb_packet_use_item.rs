use minecraft_data :: protocol :: PacketContent ; use minecraft_data :: protocol :: PacketSwitch ; use minecraft_data :: protocol :: Packet ; use std :: io :: { BufRead , Error , ErrorKind , Result , Write } ; use std :: str :: FromStr ;
 ...
 pub struct SbPacketUseItem ; impl Packet for SbPacketUseItem { type PacketIDType = i32 ; type PacketContent = PacketUseItemContent ; fn packet_id ( ) -> Self :: PacketIDType where Self : Sized { 47 } } pub struct PacketUseItemContent { hand: minecraft_data::data::VarInt ,
