use minecraft_data :: protocol :: PacketContent ; use minecraft_data :: protocol :: PacketSwitch ; use minecraft_data :: protocol :: Packet ; use std :: io :: { BufRead , Error , ErrorKind , Result , Write } ; use std :: str :: FromStr ;
 ...
 pub struct CbPacketRemoveEntityEffect ; impl Packet for CbPacketRemoveEntityEffect { type PacketIDType = i32 ; type PacketContent = PacketRemoveEntityEffectContent ; fn packet_id ( ) -> Self :: PacketIDType where Self : Sized { 59 } } pub struct PacketRemoveEntityEffectContent { pub entity_id: minecraft_data::data::VarInt ,
