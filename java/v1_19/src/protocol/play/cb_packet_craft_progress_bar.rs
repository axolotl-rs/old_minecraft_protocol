use minecraft_data :: protocol :: PacketContent ; use minecraft_data :: protocol :: PacketSwitch ; use minecraft_data :: protocol :: Packet ; use std :: io :: { BufRead , Error , ErrorKind , Result , Write } ; use std :: str :: FromStr ;
 ...
 pub struct CbPacketCraftProgressBar ; impl Packet for CbPacketCraftProgressBar { type PacketIDType = i32 ; type PacketContent = PacketCraftProgressBarContent ; fn packet_id ( ) -> Self :: PacketIDType where Self : Sized { 21 } } pub struct PacketCraftProgressBarContent { pub window_id: u8 ,
