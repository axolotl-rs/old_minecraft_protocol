use minecraft_data :: protocol :: PacketContent ; use minecraft_data :: protocol :: PacketSwitch ; use minecraft_data :: protocol :: Packet ; use std :: io :: { BufRead , Error , ErrorKind , Result , Write } ; use std :: str :: FromStr ;
 ...
 pub struct CbPacketOpenSignEntity ; impl Packet for CbPacketOpenSignEntity { type PacketIDType = i32 ; type PacketContent = PacketOpenSignEntityContent ; fn packet_id ( ) -> Self :: PacketIDType where Self : Sized { 47 } } pub struct PacketOpenSignEntityContent { location: minecraft_data::data::position::Position ,
