use minecraft_data :: protocol :: PacketContent ; use minecraft_data :: protocol :: PacketSwitch ; use minecraft_data :: protocol :: Packet ; use std :: io :: { BufRead , Error , ErrorKind , Result , Write } ; use std :: str :: FromStr ;
 ...
 pub struct SbPacketClientCommand ; impl Packet for SbPacketClientCommand { type PacketIDType = i32 ; type PacketContent = PacketClientCommandContent ; fn packet_id ( ) -> Self :: PacketIDType where Self : Sized { 4 } } pub struct PacketClientCommandContent { pub action_id: minecraft_data::data::VarInt ,
