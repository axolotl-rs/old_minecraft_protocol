use minecraft_data :: protocol :: PacketContent ; use minecraft_data :: protocol :: PacketSwitch ; use minecraft_data :: protocol :: Packet ; use std :: io :: { BufRead , Error , ErrorKind , Result , Write } ; use std :: str :: FromStr ;
 ...
 pub struct CbPacketCollect ; impl Packet for CbPacketCollect { type PacketIDType = i32 ; type PacketContent = PacketCollectContent ; fn packet_id ( ) -> Self :: PacketIDType where Self : Sized { 97 } } pub struct PacketCollectContent { pub collected_entity_id: minecraft_data::data::VarInt ,

pub collector_entity_id: minecraft_data::data::VarInt ,

pub pickup_item_count: minecraft_data::data::VarInt ,
