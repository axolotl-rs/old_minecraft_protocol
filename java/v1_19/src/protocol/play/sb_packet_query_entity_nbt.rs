use minecraft_data :: protocol :: PacketContent ; use minecraft_data :: protocol :: PacketSwitch ; use minecraft_data :: protocol :: Packet ; use std :: io :: { BufRead , Error , ErrorKind , Result , Write } ; use std :: str :: FromStr ;
 ...
 pub struct SbPacketQueryEntityNbt ; impl Packet for SbPacketQueryEntityNbt { type PacketIDType = i32 ; type PacketContent = PacketQueryEntityNbtContent ; fn packet_id ( ) -> Self :: PacketIDType where Self : Sized { 12 } } pub struct PacketQueryEntityNbtContent { pub transaction_id: minecraft_data::data::VarInt ,
