use minecraft_data :: protocol :: PacketContent ; use minecraft_data :: protocol :: PacketSwitch ; use minecraft_data :: protocol :: Packet ; use std :: io :: { BufRead , Error , ErrorKind , Result , Write } ; use std :: str :: FromStr ;
 ...
 pub struct SbPacketTeleportConfirm ; impl Packet for SbPacketTeleportConfirm { type PacketIDType = i32 ; type PacketContent = PacketTeleportConfirmContent ; fn packet_id ( ) -> Self :: PacketIDType where Self : Sized { 0 } } pub struct PacketTeleportConfirmContent { teleport_id: minecraft_data::data::VarInt ,
