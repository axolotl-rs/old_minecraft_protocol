...
pub level: minecraft_protocol::data::VarInt ,

pub total_experience: minecraft_protocol::data::VarInt ,
...
let level : minecraft_protocol::data::VarInt = PacketContent :: read ( reader ) ?;;

let total_experience : minecraft_protocol::data::VarInt = PacketContent :: read ( reader ) ?;;
