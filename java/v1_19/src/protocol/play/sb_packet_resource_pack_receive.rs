use minecraft_data :: protocol :: PacketContent ; use minecraft_data :: protocol :: PacketSwitch ; use minecraft_data :: protocol :: Packet ; use std :: io :: { BufRead , Error , ErrorKind , Result , Write } ; use std :: str :: FromStr ;
 ...
 pub struct SbPacketResourcePackReceive ; impl Packet for SbPacketResourcePackReceive { type PacketIDType = i32 ; type PacketContent = PacketResourcePackReceiveContent ; fn packet_id ( ) -> Self :: PacketIDType where Self : Sized { 33 } } pub struct PacketResourcePackReceiveContent { result: minecraft_data::data::VarInt ,
