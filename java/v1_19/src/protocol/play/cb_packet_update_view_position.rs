use minecraft_data :: protocol :: PacketContent ; use minecraft_data :: protocol :: PacketSwitch ; use minecraft_data :: protocol :: Packet ; use std :: io :: { BufRead , Error , ErrorKind , Result , Write } ; use std :: str :: FromStr ;
 ...
 pub struct CbPacketUpdateViewPosition ; impl Packet for CbPacketUpdateViewPosition { type PacketIDType = i32 ; type PacketContent = PacketUpdateViewPositionContent ; fn packet_id ( ) -> Self :: PacketIDType where Self : Sized { 73 } } pub struct PacketUpdateViewPositionContent { pub chunk_x: minecraft_data::data::VarInt ,
