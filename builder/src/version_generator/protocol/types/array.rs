...
pub fn generate_child_level_array(
    parent_name: String,
    count_type: NativeType,
    ...
    if count.is_none() {
        return Ok(GenerationResult::Failure(PacketDataType::Built {
            name: name.into(),
    ...
    let new_type = DataType::new_generated_type(
        name.to_string(),
        InnerType::Array,
        LanguageType::Rust {
...
pub fn generate_top_level_array(
    name: TypeName,
    count_type: NativeType,
    data_type: PacketDataType,
    state: &TypesGenerator,
